...
此repository是基于[PaddleDetection](https://github.com/PaddlePaddle/PaddleDetection)的`YOLO集合`，其upstream为PaddleDetection的[develop](https://github.com/PaddlePaddle/PaddleDetection/tree/develop)分支，是精简版本的代码，只保留YOLO系列模型(YOLOv3、PP-YOLO、PP-YOLOv2、PP-YOLOE、YOLOX、YOLOv5)，以及保留了YOLO相关的多目标跟踪算法。

**注意:**
 - github链接为：https://github.com/nemonameless/PaddleDetection_YOLOset
 - gitee链接为：https://gitee.com/nemonameless/PaddleDetection_YOLOset
